            ...
            <ul class="flex">
                ...
                <li class="flex">
                    <div class="flex items-center">
                        ...
                        <a href="" class="dark:text-gray-400">Post</a>
                    </div>
                </li>
                <li class="flex">
                    <div class="flex items-center">
                        <svg class="w-6 h-full mx-4 text-gray-300 dark:text-gray-400" viewBox="0 0 24 44" preserveAspectRatio="none" fill="currentColor" aria-hidden="true"><path d="M.293 0l22 22-22 22h1.414l22-22-22-22H.293z"></path></svg>
                        <a href="" class="dark:text-gray-400">Post list</a>
                    </div>
                </li>
            </ul>
            <button type="button" class="font-semibold text-gray-500 dark:text-gray-400"><a href="{{route('post.create')}}">Create</a></button>
        </div>
    </x-slot>
                ...
                <td class="px-6 py-4">
                    <form method="post" action="{{route('post.destroy',$post->id)}}">
                        <div class="text-center">
                            ...
                            <a href="{{route('post.edit',$post->id)}}" class="px-3 py-2 text-xs font-medium text-center inline-flex items-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:outline-none dark:bg-blue-600 dark:hover:bg-blue-700">Edit</a>
                            @csrf
                            @method('delete')
